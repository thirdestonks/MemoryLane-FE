              ...
              <form class="mt-8 space-y-4">
                <div>
                  ...
                  <div class="relative flex items-center">
                    <input v-model="form.email" name="email" type="text" required class="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Enter Email" />
                ...
                <div>
                  ...
                  <div class="relative flex items-center">
                    <input v-model="form.password" name="password" type="password" required class="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Enter password" />
